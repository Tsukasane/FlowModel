...
from modules.CFM.matcha.components.decoder import SinusoidalPosEmb, Block1D, ResnetBlock1D, Downsample1D, TimestepEmbedding, Upsample1D
from modules.CFM.matcha.components.transformer import BasicTransformerBlock
...
class ConditionalDecoder(nn.Module):
    ...
    def forward(self, x, mask, mu, t, spks=None, cond=None):
        ...
        Args:
            ...
            mu (torch.Tensor): output of encoder  32, 512, 357
        ...
        masks = masks[:-1]
        mask_mid = masks[-1] # 32, 1, 179

        for resnet, transformer_blocks in self.mid_blocks:
            x = resnet(x, mask_mid, t) # --> 32, 256, 179
            x = rearrange(x, "b c t -> b t c").contiguous()
